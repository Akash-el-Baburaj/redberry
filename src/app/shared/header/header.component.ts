...
import { Header, Welcomebar } from 'src/app/ngrx/reducers';
...
export class HeaderComponent implements OnInit {
  ...
  constructor(private router: Router, private modalService: NgbModal, private formBuilder: UntypedFormBuilder,public languageService: LanguageService,
    public _cookiesService: CookieService, public translate: TranslateService, private ngrxStore: Store) {
      this.ngrxStore.select(selectThemeSettings).subscribe((settings:any)=>{
        console.log(settings)
        this.headerSettings = settings?.header
        this.welcomeBarSettings = settings?.welcomebar
      })
  }
